...
const ShoppingBasket = createLucideIcon("shopping-basket", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Huyền Trinh" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed", children: "Nơi mỗi chiếc bánh là một câu chuyện và mỗi tách cà phê là một khoảnh khắc đáng nhớ." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground italic", children: "Coffee & Bake — Nha Trang" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground uppercase tracking-widest", children: "Khám phá" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground uppercase tracking-widest", children: "Liên hệ" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body", children: "12 Trần Phú, Lộc Thọ, Nha Trang, Khánh Hòa" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body", children: "0905 123 456" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body", children: "huyentrinh@gmail.com" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
            "© ",
            year,
            " Huyền Trinh Coffee & Bake. Bảo lưu mọi quyền."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
...
function CartProvider({ children }) {
  ...
  const addItem = reactExports.useCallback((newItem) => {
    setItems((prev) => {
  ...
  const updateQuantity = reactExports.useCallback((id, quantity) => {
    if (quantity <= 0) {
      setItems((prev) => prev.filter((i) => i.id !== id));
    } else {
      setItems(
        (prev) => prev.map((i) => i.id === id ? { ...i, quantity } : i)
      );
    }
  }, []);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl md:text-2xl font-bold text-foreground tracking-tight group-hover:text-primary transition-colors duration-200", children: "Huyền Trinh" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground tracking-widest uppercase", children: "Coffee & Bake" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: NAV_LINKS.map((link) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    to: link.to,
                    className: `px-4 py-2 rounded-lg font-body text-sm transition-smooth ${isActive ? "bg-secondary text-secondary-foreground font-semibold" : "text-foreground hover:bg-muted hover:text-foreground"}`,
                    children: link.label
                  },
                  link.to
                );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBasket, { className: "w-5 h-5 text-foreground" }),
                  totalItems > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 bg-accent text-accent-foreground text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center", children: totalItems > 9 ? "9+" : totalItems })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: NAV_LINKS.map((link) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: `px-4 py-3 rounded-lg font-body text-sm transition-smooth ${isActive ? "bg-secondary text-secondary-foreground font-semibold" : "text-foreground hover:bg-muted"}`,
                  children: link.label
                },
                link.to
              );
...
const PRODUCTS = [
  {
    ...
    description: "Lớp vỏ giòn tan, nhân bơ thơm ngậy theo phong cách Pháp truyền thống",
    price: 35e3,
    category: "banh",
  ...
  },
  {
    ...
    description: "Cheesecake New York mịn màng, phủ topping việt quất tươi ngọt thanh",
    price: 65e3,
  ...
  },
  {
    ...
    description: "Cà phê nhẹ nhàng pha sữa đặc Ông Thọ, uống là nhớ cả tuổi thơ",
    price: 4e4,
    category: "ca-phe",
...
function DatHangPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Đặt hàng" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: "Đặt hàng online" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Đặt trước — nhận ngay tại cửa hàng" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-lg", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "card-base text-center space-y-4 py-12",
        "data-ocid": "order-success",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/20 flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-8 h-8 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Cảm ơn bạn đã đặt hàng!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Chúng tôi sẽ liên hệ xác nhận đơn hàng trong vòng 30 phút." }),
          selectedProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-4 text-left space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "Sản phẩm đã đặt:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: selectedProduct.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-primary", children: [
              form.soLuong,
              " × ",
      ...
      "form",
      {
        ...
        noValidate: true,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold text-foreground", children: "Thông tin đặt hàng" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            errors.hoTen && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: errors.hoTen })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
            ...
            errors.soDienThoai && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: errors.soDienThoai })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "-- Chọn sản phẩm --" }),
            ...
            errors.sanPham && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: errors.sanPham })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
            ...
            errors.soLuong && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: errors.soLuong })
          ] }),
          selectedProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-3 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-muted-foreground", children: "Tạm tính:" }),
...
function GioHangPage() {
  ...
  if (paid) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: "Thanh toán thành công" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-base text-center space-y-5 py-12",
          "data-ocid": "checkout-success",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/20 flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBasket, { className: "w-8 h-8 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Cảm ơn bạn đã mua hàng!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Chúng tôi sẽ xử lý đơn hàng và liên hệ với bạn sớm nhất." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Giỏ hàng" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl font-bold text-foreground", children: [
        "Giỏ hàng của bạn",
        totalItems > 0 && ` (${totalItems})`
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-4xl", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "card-base text-center space-y-5 py-16",
        "data-ocid": "cart-empty",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBasket, { className: "w-8 h-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold text-foreground", children: "Giỏ hàng đang trống" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Hãy thêm một vài sản phẩm yêu thích của bạn nhé!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/san-pham",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", "data-ocid": "cart-table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left pb-3 font-display text-xs text-muted-foreground uppercase tracking-wide w-1/2", children: "Tên sản phẩm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center pb-3 font-display text-xs text-muted-foreground uppercase tracking-wide", children: "Số lượng" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right pb-3 font-display text-xs text-muted-foreground uppercase tracking-wide", children: "Giá" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-3 w-10" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "group",
            "data-ocid": `cart-item-${item.id}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-4 pr-4 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground truncate", children: item.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-muted-foreground", children: [
                  formatPrice(item.price),
                  " / cái"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 text-center font-display font-semibold text-foreground text-sm", children: item.quantity }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 pl-2 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-primary", children: formatPrice(item.price * item.quantity) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 pl-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground", children: "Tóm tắt đơn hàng" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 border-b border-border pb-4", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex justify-between items-start gap-2",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-sm text-muted-foreground flex-1 min-w-0 truncate", children: [
                    item.name,
                    " ×",
                    item.quantity
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-foreground shrink-0", children: formatPrice(item.price * item.quantity) })
                ]
              },
              item.id
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: "Tổng cộng" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-primary text-xl", children: formatPrice(totalPrice) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
const VALUES = [
  {
    icon: Heart,
    title: "Tâm huyết",
    description: "Mỗi chiếc bánh được làm thủ công với tình yêu và sự tỉ mỉ từng chi tiết nhỏ."
  },
  {
    icon: Leaf,
    title: "Nguyên liệu tươi",
    description: "Chọn lọc nguyên liệu sạch, tươi ngon từ các nhà cung cấp uy tín trong nước."
  },
  {
    icon: Award,
    title: "Chất lượng cao",
    description: "Tiêu chuẩn an toàn thực phẩm nghiêm ngặt, bảo đảm sức khỏe cho khách hàng."
  }
];
const MILESTONES = [
  {
...
function GioiThieuPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-16 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Về chúng tôi" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl lg:text-5xl font-bold text-foreground", children: "Huyền Trinh Coffee & Bake" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground max-w-xl mx-auto leading-relaxed", children: "Từ góc nhỏ yêu thương ở Nha Trang, chúng tôi mang đến những khoảnh khắc ngọt ngào đáng nhớ." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Lịch sử hình thành" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed", children: "Huyền Trinh bắt đầu từ niềm đam mê làm bánh thuần túy của người sáng lập — chị Huyền Trinh Nguyễn. Sau nhiều năm học hỏi kỹ thuật làm bánh tại Pháp và Nhật Bản, chị quyết định mang những kỹ năng đó về quê hương Nha Trang để tạo nên một không gian vừa tinh tế vừa gần gũi." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed", children: "Khởi đầu với một chiếc lò nướng nhỏ và tình yêu vô bờ, Huyền Trinh đã dần trở thành điểm đến quen thuộc của những người yêu bánh và cà phê chất lượng tại thành phố biển." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: MILESTONES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex gap-4 items-start",
          "data-ocid": "milestone-item",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-16 h-16 rounded-xl bg-secondary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-bold text-secondary-foreground", children: m.year }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 pt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground", children: m.event }) })
          ]
        },
        m.year
      )) })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Sứ mệnh & Tầm nhìn" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground max-w-lg mx-auto", children: "Chúng tôi tin vào sức mạnh của những điều giản dị — một chiếc bánh ngon, một tách cà phê ấm, và một không gian để lòng được nghỉ ngơi." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: VALUES.map((value) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-accent/20 flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-accent" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground", children: value.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Sản phẩm & Dịch vụ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Đa dạng lựa chọn cho mọi dịp" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: service.desc })
          ]
        },
        service.title
      )) })
...
function GopYPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Phản hồi" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: "Góp ý của bạn" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Ý kiến của bạn giúp chúng tôi hoàn thiện hơn mỗi ngày" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-lg", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/20 flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-8 h-8 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Cảm ơn bạn đã gửi phản hồi!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Chúng tôi đã nhận được ý kiến của bạn và sẽ cải thiện dịch vụ tốt hơn." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      "form",
      {
        ...
        noValidate: true,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold text-foreground", children: "Gửi góp ý" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                ...
                className: `w-full px-4 py-3 rounded-lg border bg-background font-body text-foreground placeholder:text-muted-foreground transition-smooth focus:outline-none focus:ring-2 focus:ring-ring resize-none ${errors.noiDung ? "border-destructive" : "border-input"}`,
                "data-ocid": "feedback-content"
              }
            ),
            errors.noiDung && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: errors.noiDung })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
...
function HomePage() {
  const { addItem } = useCart();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[520px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden order-first lg:order-last", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-card/20 lg:bg-gradient-to-r lg:from-card/10 lg:via-transparent lg:to-transparent" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center py-16 lg:py-24 pr-0 lg:pr-12 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Nha Trang · Khánh Hòa" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight", children: "Khoảnh khắc ngọt ngào bắt đầu tại đây" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed max-w-md", children: "Thưởng thức hương vị bánh nghệ thuật và cà phê đậm đà bản sắc Việt tại không gian tinh tế của Huyền Trinh." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Câu chuyện của chúng tôi" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed", children: "Huyền Trinh Coffee & Bake được thành lập năm 2018 tại Nha Trang với tình yêu thuần khiết dành cho bánh thủ công và cà phê chất lượng. Chúng tôi tin rằng mỗi chiếc bánh là một tác phẩm nghệ thuật, và mỗi tách cà phê là một trải nghiệm đáng trân trọng." })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Hương vị đặc trưng" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Những món được yêu thích nhất tại Huyền Trinh" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6", children: PRODUCTS.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-base p-0 overflow-hidden group cursor-pointer",
          "data-ocid": `product-card-${product.id}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden h-40 md:h-48 bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.image,
                alt: product.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm md:text-base font-semibold text-foreground leading-snug", children: product.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-primary text-sm", children: formatPrice(product.price) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Hệ thống cửa hàng" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Tìm chúng tôi tại Nha Trang" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto", children: BRANCHES.map((branch) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-base flex gap-4 items-start",
          "data-ocid": "branch-card",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground", children: branch.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1", children: branch.address }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-2 text-xs text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body", children: "07:00 – 22:00 hàng ngày" })
              ] })
            ] })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-primary-foreground", children: "Đặt hàng trước — nhận ưu đãi đặc biệt" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary-foreground/80", children: "Liên hệ đặt bánh sinh nhật, tiệc hoặc quà tặng theo yêu cầu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/dat-hang",
...
function LienHePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Kết nối" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: "Liên hệ với chúng tôi" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Chúng tôi luôn sẵn sàng lắng nghe bạn" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: CONTACT_ITEMS.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm uppercase tracking-wide", children: item.label }),
              item.lines.map(
                (line) => item.href ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: item.href,
                  ...
                  line
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-foreground", children: line }, line)
              )
            ] })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-base text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Giờ mở cửa" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-muted-foreground", children: row.day }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: row.hours })
          ]
        },
        row.day
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "* Đặc biệt: Mở cửa vào các ngày lễ, Tết theo thông báo trên fanpage" })
    ] }) }) })
  ] });
}
function SanPhamPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card py-12 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-accent font-semibold tracking-widest uppercase", children: "Menu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: "Sản phẩm của chúng tôi" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground", children: "Tất cả được chế biến tươi mỗi ngày" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-8 border-b border-border sticky top-[64px] md:top-[80px] z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filters.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `px-4 py-2 rounded-lg font-body text-sm transition-smooth ${filter === f.value ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-secondary hover:text-secondary-foreground"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/20 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-5", children: filtered.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-base p-0 overflow-hidden group",
          "data-ocid": `product-${product.id}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 md:h-56 overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.image,
                alt: product.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-accent font-semibold uppercase tracking-wide", children: CATEGORY_LABELS[product.category] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mt-1 leading-snug", children: product.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1 line-clamp-2", children: product.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold transition-smooth ${added === product.id ? "bg-accent/30 text-foreground" : "bg-accent/20 text-foreground hover:bg-accent hover:text-accent-foreground"}`,
                    "data-ocid": `add-to-cart-${product.id}`,
                    children: added === product.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3.5 h-3.5" }),
                      " Đã thêm"
                    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBasket, { className: "w-3.5 h-3.5" }),
                      " Thêm vào giỏ"
                    ] })
                  }
                )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mt-12 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-sm", children: "Muốn đặt số lượng lớn hoặc theo yêu cầu?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/dat-hang",
